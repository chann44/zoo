...
import { Activity, AppWindow, Boxes, Server, Wifi } from "lucide-react"
...
export const Route = createFileRoute("/_app/monitoring")({ component: AnalyticsPage })
...
function AnalyticsPage() {
  ...
  return (
    <Page
      icon={Activity}
      title="Monitoring"
      description="Fleet-wide overview across every registered computer."
      action={
        <>
